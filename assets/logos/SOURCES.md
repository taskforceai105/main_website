...
- `openai.png`: `https://github.com/openai.png?size=200`
- `gemini.svg`: `https://www.gstatic.com/lamda/images/gemini_sparkle_aurora_33f86dc0c0257da337c63.svg`
- `anthropic.ico`: `https://www.anthropic.com/favicon.ico`
- `xai.ico`: `https://x.ai/favicon.ico`
- `qwen.ico`: `https://g.alicdn.com/qwenweb/qwen-ai-fe/0.0.4/favicon.ico`
- `perplexity.ico`: `https://www.perplexity.ai/favicon.ico`
